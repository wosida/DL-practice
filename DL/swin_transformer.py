...
class SwinTransformer(nn.Module):
    ...
    Args:
        img_size (int | tuple(int)): Input img size. Default 224
        patch_size (int | tuple(int)): Patch size. Default: 4
        in_chans (int): Number of input img channels. Default: 3
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        # split img into non-overlapping patches
        ...
        for i_layer in range(self.num_layers):
            ...
            #构建了4个BasicLayer，每个BasicLayer包含了多个BasicBlock,分别是2,2,6,2个,所以总共有12个BasicBlock
